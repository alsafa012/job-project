...
const Banner = () => {
     ...
     const sliders = [
          {
               img: "https://i.ibb.co/ygDbTRj/images.jpg",
               title: "Welcome to our website",
               des: "Choose your dream home here...",
          },
          {
               img: "https://i.ibb.co/jrzw0L9/images-1.jpg",
               title: "Welcome to our website",
               des: "Choose your dream home here...",
          },
          {
               img: "https://i.ibb.co/mS6hdX0/images-2.jpg",
               title: "Welcome to our website",
               des: "Choose your dream home here...",
          },
          {
               img: "https://i.ibb.co/17QRzdv/images-3.jpg",
               title: "Welcome to our website",
               des: "Choose your dream home here...",
          },
          {
     ...
     return (
          <div
               className="w-full h-72 sm:h-96 md:h-[540px] lg:h-[640px] xl:h-[780px] flex flex-col xl:flex-row items-center justify-center gap-5 lg:gap-10 relative bg-cover before:absolute before:bg-black/50 before:inset-0 transform duration-1000 ease-linear overflow-hidden"
               style={{
                    backgroundImage: `url(${
                         currentSlider === 0
          ...
          >
               ...
               {/* slider container */}
               <div className="w-1/2 ml-auto overflow-hidden  absolute -right-5 lg:-right-16 px-4 py-10">
                    <div
